    ...
    <div className="p-5 rounded-xl bg-[#f8f8fa]">
      <div className="flex items-center justify-between">
        <h1 className="font-semibold text-xl mx-3">
          Order Return List <br />
          <span className="font-normal text-sm">Manage your return orders</span>
        </h1>
      </div>
        ...
        <table className="w-full mt-4">
          <thead>
            <tr className="rounded-xl">
              ...
              <th className="p-2 w-2/12">Return Reason</th>
          ...
          <tbody>
            <tr className="text-center my-2">
              ...
              <td className="border-b px-4 py-2">Defective piece</td>
              <td className="border-b px-4 py-2">
            ...
            <tr className="text-center my-2">
              ...
              <td className="border-b px-4 py-2">Mukesh</td>
              <td className="border-b px-4 py-2">Gaziabad</td>
              <td className="border-b px-4 py-2">HVAC Works</td>
              <td className="border-b px-4 py-2">90tg34</td>
            ...
            <tr className="text-center my-2">
              ...
              <td className="border-b px-4 py-2">Atul</td>
              <td className="border-b px-4 py-2">Gaziabad</td>
              <td className="border-b px-4 py-2">Water ATMs</td>
              <td className="border-b px-4 py-2">32r45d</td>
              <td className="border-b px-4 py-2">Outdoor Advertising</td>
